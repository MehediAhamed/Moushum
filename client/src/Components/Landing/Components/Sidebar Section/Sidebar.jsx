    ...
    <div className='sideBar grid'>
      ...
      <div className="sideBarCard">
        ...
        <div className="cardContent">
          ...
          <button className='btn' onClick={() => { window.location.href = `https://mail.google.com/mail/?view=cm&fs=1&to=${support}&su=${"Requesting Support from Moushum Team"}`;}} >যোগাযোগ করুন</button>
        </div>
      </div>
    </div>
  )
